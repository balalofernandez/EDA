 ...
 * @author mayte
 */
public class InorderNAryTreeTest {

    public InorderNAryTreeTest() {
    }
    ...
    public void testIterator() {
        ...
        String salida = "";
        InorderNAryTreeIteratorTimes2<String> it = new InorderNAryTreeIteratorTimes2<>(t);
        while (it.hasNext()) {
            salida += it.next().getElement();
        }
        assertEquals("HBDAEGCIFJ",salida);
    }
