...
public class ELDigraph<V, E> implements Digraph<V, E> {
    ...
    class ELVertex<V> implements Vertex<V> {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof ELVertex)) {
                return false;
            }
            ELVertex<V> c = (ELVertex<V>) o;
            return c.getElement().equals(this.getElement());
        }
    ...
    class ELEdge<E, V> implements Edge<E> {
        ...
        public boolean equals(Object obj) {
            ...
            return other.getStartVertex().equals(this.getStartVertex()) && other.getEndVertex().equals(this.getEndVertex());
        }
    ...
    private Set<ELVertex<V>> vertexList;
    private Set<ELEdge<E, V>> edgeList;
    ...
    public ELDigraph(Set<ELVertex<V>> vertexList, Set<ELEdge<E,V>> edgeList) {
    ...
    public void setVertexList(Set<ELVertex<V>> vertexList) {
        this.vertexList = vertexList;
    }

    public Set<ELEdge<E, V>> getEdgeList() {
        return edgeList;
    }

    public void setEdgeList(Set<ELEdge<E, V>> edgeList) {
        this.edgeList = edgeList;
    }

    public Digraph<V,E> copiaGrafo(){
        return new ELDigraph<V,E>(vertexList,edgeList);
    }
